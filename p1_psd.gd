...
@onready var buff_icon = $/root/Node2D/buttle/player1/p1_icon/バフアイコン
@onready var buff_turn = $/root/Node2D/buttle/player1/p1_icon/buff_turn
@onready var debuff_icon = $/root/Node2D/buttle/player1/p1_icon/デバフアイコン
@onready var debuff_turn = $/root/Node2D/buttle/player1/p1_icon/debuff_turn
