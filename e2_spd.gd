...
@onready var buff_icon = $/root/Node2D/enemies/enemy2/e2_icon/バフアイコン
@onready var buff_turn = $/root/Node2D/enemies/enemy2/e2_icon/buff_turn
@onready var debuff_icon = $/root/Node2D/enemies/enemy2/e2_icon/デバフアイコン
@onready var debuff_turn = $/root/Node2D/enemies/enemy2/e2_icon/debuff_turn
