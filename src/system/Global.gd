...
var autoload_scene_array: Array[PackedScene] = [
	preload("res://scene/component/accept_dialog.tscn"), 
	preload("res://scene/component/confirmation_dialog.tscn"), 
]
...
const map_scene = "res://scene/game_scene/map.tscn"
const select_scene = "res://scene/game_scene/monster_setting.tscn"
const battle_scene = "res://scene/game_scene/battle.tscn"
const deck_save_scene = "res://scene/game_scene/deck_select.tscn"
const tutorial_scene = "res://scene/game_scene/tutorial.tscn"
const shop_scene = "res://scene/game_scene/shop.tscn"

const debug_scene = "res://scene/debug/debug.tscn"

const game_button = preload("res://scene/component/game_button.tscn")
const monster_icon = preload("res://scene/component/monster_icon.tscn")
const inventory_scene = preload("res://scene/component/inventory.tscn")
const action_button = preload("res://scene/component/action_button.tscn")
const ability_description = preload("res://scene/component/ability_description.tscn")
...
func _ready() -> void:
	...
	directory_load("res://resource/monster_data/", monster_data)
	directory_load("res://resource/action_data/", action_data)
	directory_load("res://resource/item/", item_data)
	directory_load("res://resource/stage/", stage_data)
