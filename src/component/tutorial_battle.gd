...
func _on_cutin_ended() -> void:
	...
	await dialog.text_setter(load("res://resource/battlelog_data/tutorial/tutorial1.tres"))
	...
	get_tree().paused = true
	tree_paused()
	await dialog.text_setter(load("res://resource/battlelog_data/tutorial/tutorial2.tres"))
	get_tree().paused = false
	tree_paused()
...
func _on_player_ready() -> void:
	...
	dialog.text_setter(load("res://resource/battlelog_data/tutorial/tutorial3.tres"))
	await $button.status_paging
	arrow_mark_hide()
	await dialog.text_setter(load("res://resource/battlelog_data/tutorial/tutorial4.tres"))
	back_disabled = false
	$button/戻る.disabled = false
	arrow_mark_setter(150, "red", 0, Vector2(45, 775))
	dialog.text_setter(load("res://resource/battlelog_data/tutorial/tutorial5.tres"))
	await $button.back
...
func _on_action_button_up() -> void:
	back_disabled = true
	arrow_mark_hide()
	await dialog.text_setter(load("res://resource/battlelog_data/tutorial/tutorial6.tres"))
	$button/action.get_child(0).disabled = false
	dialog.text_setter(load("res://resource/battlelog_data/tutorial/tutorial7.tres"))
	$button/target/target1.disabled = true
	await $button.description_paging
	await dialog.text_setter(load("res://resource/battlelog_data/tutorial/tutorial8.tres"))
	$button/target/target1.disabled = false
	arrow_mark_setter(150, "red", 0, Vector2(248, 640))
	dialog.text_setter(load("res://resource/battlelog_data/tutorial/tutorial9.tres"))
	...
	dialog.text_setter(load("res://resource/battlelog_data/tutorial/tutorial10.tres"))
